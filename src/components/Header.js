...
const Header = () => {
  ...
  return (
    <div className="z-10 absolute w-screen px-8 py-2 bg-gradient-to-b from-black flex justify-between">
      ...
      {user && (
        <div className="flex p-2 items-center">
          ...
          <button
            ...
            className="font-bold py-2 px-4 m-2 bg-red-700 rounded-lg text-white"
          >
